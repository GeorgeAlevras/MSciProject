...
if __name__ == '__main__':
    ...
    model_results_best = np.array(run_model('seirv', best_params, new_states)[0])
    ...
    for conf, lim0, lim1, lim2, lim3 in zip(samples.contours, lims0, lims1, lims2, lims3):
