...
def sirhd_odes(t, x, b_1, b_2, g, h, d):
    ...
    b_t = 3*[0.15] + 7*[0.165] + 10*[0.172] + 5*[0.175] + 5*[0.17] + 8*[0.165] + 12*[0.13] + 5*[0.145] + 5*[0.17] + 20*[0.18] + [0.19, 0.19, 0.2, 0.2, 0.21, 0.22, 0.23, 0.24, 0.25, 0.26] + \
        [0.27, 0.29, 0.3, 0.32, 0.31, 0.31, 0.31, 0.3, 0.3, 0.3, 0.3, 0.29, 0.29, 0.28, 0.28, 0.27, 0.27, 0.26] + [0.26, 0.26, 0.26, 0.25, 0.24, 0.24] + 8*[0.23]
...
def sirhd_odes_max(t, x, b_1, b_2, g, h, d):
    # Compartments
    S = x[0]  # Susceptible
    I = x[1]  # Infected
    R = x[2]  # Recovered
    ...
    b_t = 3*[0.15] + 7*[0.165] + 10*[0.172] + 5*[0.175] + 5*[0.17] + 8*[0.165] + 12*[0.13] + 5*[0.145] + 5*[0.17] + 20*[0.18] + [0.19, 0.19, 0.2, 0.2, 0.21, 0.22, 0.23, 0.24, 0.25, 0.26] + \
        [0.27, 0.29, 0.3, 0.32, 0.31, 0.31, 0.31, 0.3, 0.3, 0.3, 0.3, 0.29, 0.29, 0.28, 0.28, 0.27, 0.27, 0.26] + [0.26, 0.26, 0.26, 0.27, 0.27, 0.27, 0.26, 0.26] + 6*[0.25]
...
def sirhd_odes_min(t, x, b_1, b_2, g, h, d):
    # Compartments
    S = x[0]  # Susceptible
    I = x[1]  # Infected
    R = x[2]  # Recovered
    ...
    b_t = 3*[0.15] + 7*[0.165] + 10*[0.172] + 5*[0.175] + 5*[0.17] + 8*[0.165] + 12*[0.13] + 5*[0.145] + 5*[0.17] + 20*[0.18] + [0.19, 0.19, 0.2, 0.2, 0.21, 0.22, 0.23, 0.24, 0.25, 0.26] + \
        [0.27, 0.29, 0.3, 0.32, 0.31, 0.31, 0.31, 0.3, 0.3, 0.3, 0.3, 0.29, 0.29, 0.28, 0.28, 0.27, 0.27, 0.26] + [0.26, 0.25, 0.22, 0.21, 0.21, 0.21] + 8*[0.19]
...
def sirhd_odes_noise(t, x, b_1, b_2, g, h, d, stochastic_noise_f=0):
    ...
    b_t = 3*[0.15] + 7*[0.165] + 10*[0.172] + 5*[0.175] + 5*[0.17] + 8*[0.165] + 12*[0.13] + 5*[0.145] + 5*[0.17] + 20*[0.18] + [0.19, 0.19, 0.2, 0.2, 0.21, 0.22, 0.23, 0.24, 0.25, 0.26] + \
        [0.27, 0.27, 0.28, 0.28, 0.28, 0.28, 0.29, 0.3, 0.31, 0.32, 0.32, 0.33, 0.31, 0.31, 0.29, 0.28, 0.27, 0.27] + 14*[0.27]
...
models = {
    'sirhd':sirhd_odes,
    'sirhd_min': sirhd_odes_min,
    'sirhd_max': sirhd_odes_max,
