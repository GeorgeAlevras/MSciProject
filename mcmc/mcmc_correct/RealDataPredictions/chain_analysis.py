...
if __name__ == '__main__':
    ...
    samples = loadMCSamples('./ConvertedFiles/convert', settings={'ignore_rows':5})  # , settings={'ignore_rows':10}
    ...
    best_params = [float(best_stats[4]), float(best_stats[9]), float(best_stats[14]), float(best_stats[19]), float(best_stats[24]), float(best_stats[29]), float(best_stats[34])]
