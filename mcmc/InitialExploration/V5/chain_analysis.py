...
if __name__ == '__main__':
    ...
    best_params = [float(best_stats[3+5*i]) for i in range(0, 11)]
    
    plt.figure(1)
    X = ['b_a', 'b_sy', 'g_a', 'g_sy', 'g_h', 'e_a', 'e_sy', 'a', 'h', 'v', 'd_h']
    ...
    model_results_best = np.array(run_model('seasyhrvd', best_params, new_states)[0])
    ...
    g.triangle_plot([samples], ['p1', 'p2','p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10', 'p11'], 
        filled_compare=True, 
    ...
    print(samples.getInlineLatex('p10',limit=2))
    print(samples.getInlineLatex('p11',limit=2))
    print(samples.getTable().tableTex())
    print(samples.PCA(['p1', 'p2','p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10', 'p11']))
    print('\n')
    ...
    for conf, lim0, lim1, lim2, lim3, lim4, lim5, lim6, lim7, lim8, lim9, lim10 in zip(samples.contours, lims0, \
        lims1, lims2, lims3, lims4, lims5, lims6, lims7, lims8, lims9, lims10):
